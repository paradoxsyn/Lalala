...
public class GameState3 extends State {
    ...
    private float[] tint = {0.8f, 0, 0.2f,1, 0.212f, 0.031f,1, 0.596f, 0.2f,0.933f, 0, 0.235f};
    private float[] fluxertint = {1f, 0.831f, 0.047f};
    private float[] fluxertint2 = {1, 0.122f, 0.047f};
    private float[] bursttint = {1, 0.4f, 0.4f, 0.8f, 0, 0, 1, 0.2f, 0.2f};
    ...
    private boolean fizzonce = false;
    ...
    public GameState3(StateManager manager, float speed, int level){
        super(manager);
        ...
        bg = new com.badlogic.gdx.scenes.scene2d.ui.Image(Assets.ryzeflip3);
        bg2 = new com.badlogic.gdx.scenes.scene2d.ui.Image(Assets.ryzeflip3);
        bg3 = new com.badlogic.gdx.scenes.scene2d.ui.Image(Assets.ryzeflip3);
        bg4 = new com.badlogic.gdx.scenes.scene2d.ui.Image(Assets.ryzeflip3);
    ...
    public void draw() {
        ...
        if(level4) {
            ...
            if(randomReng==0 && !aureltouch1){
                leapStrike(talonwarp.actorTalon());

            }
            else if(randomReng==1 && !aureltouch2){
                leapStrike(tahmwarp.actorTahm());
            }
            else if(randomReng==3 && !aureltouch3){
                leapStrike(ren.actorRen());
            }
            else if(randomReng==4 && !aureltouch4){
    ...
    public void bouncefinish(){
        if(bouncefinished && bouncefinished2 && bouncefinished3 && bouncefinished4){
            ...
            if(hit1&&hit2&&hit3&&hit4){
                prefs.putBoolean("unlocklevel4",true);
            }
        }
    }
