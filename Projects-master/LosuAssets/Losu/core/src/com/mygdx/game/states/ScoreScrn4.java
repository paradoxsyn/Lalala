...
public class ScoreScrn4 extends State{
    ...
    public ScoreScrn4(final StateManager manager){
        super(manager);
        stage = new Stage();
        ...
        SimpleDirectionGestureDetector list = new SimpleDirectionGestureDetector(new SimpleDirectionGestureDetector.DirectionListener() {
            @Override
            public void onLeft() {
                //manager.set(new ScoreScrn3(manager));
            }
        ...
        text = new TextField("Scene 4:",style);
        ...
        score1 = new TextField(""+crystals4,style2);
