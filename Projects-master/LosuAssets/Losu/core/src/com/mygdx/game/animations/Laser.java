...
public class Laser {
    ...
    public void render(float delta) {
        ...
        //added code
        begin1.setSize(600,begin1.getHeight());
        begin2.setSize(600,begin1.getHeight());
        //begin1.setSize(600,distance);
        //begin2.setSize(600,distance);

        end1.setSize(600, begin1.getHeight());
        end2.setSize(600,begin1.getHeight());

        mid1.setSize(600, distance);
        mid2.setSize(600, distance);
