...
public class ScoreScrn2 extends State{
    ...
    public ScoreScrn2(final StateManager manager){
        super(manager);
        stage = new Stage();
        ...
        text = new TextField("Scene 2:",style);
        ...
        score1 = new TextField(""+crystals2,style2);
