...
import com.mygdx.game.LosuScrn;
import com.mygdx.game.resources.Assets;
import com.mygdx.game.states.ScoreScrn;
...
public class Loader extends ScreenAdapter {
    ...
    public void show() {
        ...
        game.manager.load("heimertitle.jpg", Texture.class);
        game.manager.load("losulogo.png", Texture.class);
        game.manager.load("overloadpng.png",Texture.class);
        game.manager.load("runeprispng.png",Texture.class);
        game.manager.load("spellfluxpng.png",Texture.class);
        game.manager.load("realmwarppng.png",Texture.class);
        game.manager.load("realmcircle.png",Texture.class);
        game.manager.load("ryzerange.jpg",Texture.class);

        game.manager.load("Annie.png",Texture.class);
        game.manager.load("Renekton.png",Texture.class);
        game.manager.load("TahmKench.png",Texture.class);
        game.manager.load("Talon.png",Texture.class);

        game.manager.load("porodata.txt", TextureAtlas.class);
        game.manager.load("tahmdata.txt", TextureAtlas.class);
